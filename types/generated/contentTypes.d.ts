...
export interface ApiAppiontmentAppiontment extends Schema.CollectionType {
  collectionName: 'appiontments';
  info: {
    singularName: 'appiontment';
    pluralName: 'appiontments';
    displayName: 'Appiontment';
    description: '';
  };
  options: {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::appiontment.appiontment': ApiAppiontmentAppiontment;
